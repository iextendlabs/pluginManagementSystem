...
<tr><th>',lang(31),'<td>',html_select("auth[driver]",$Xb,DRIVER),'<tr><th>',lang(32),'<td><input name="auth[server]" value="localhost" title="hostname[:port]" placeholder="localhost" autocapitalize="off">
<tr><th>',lang(33),'<td><input name="auth[username]" id="username" value="root" autocapitalize="off">
<tr><th>',lang(34),'<td><input value="" type="password" name="auth[password]">
